...
<br> - The new RDK is integrated into the latest jsPsych 6 library, which can be found [here](https://github.com/jspsych/jsPsych/blob/master/plugins/jspsych-rdk.js).
